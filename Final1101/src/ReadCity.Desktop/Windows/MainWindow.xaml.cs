    ...
    public partial class MainWindow : Window
    {
        ...
        private void ApplyFilters()
        {
            ...
            var query = new ProductQuery
            {
                ...
                ManufacturerId = ManufacturerBox.SelectedItem is Manufacturer manufacturer && manufacturer.Id > 0 ? manufacturer.Id : null,
        ...
        private static decimal? ParsePrice(string text)
        {
            ...
            return decimal.TryParse(normalized, NumberStyles.Any, CultureInfo.InvariantCulture, out var value) && value >= 0 ? value : null;
        }
