...
{
    /// <summary>
    /// Окно оформления текущего заказа.
    /// </summary>
    public partial class OrderWindow : Window
    {
        public OrderWindow()
        {
            ...
            ClientText.Text = AppState.CurrentUser is null ? "Заказ оформляется от имени гостя." : $"Клиент: {AppState.CurrentUser.FullName}";
        ...
        private string BuildTalon(Order order)
        {
            ...
            builder.AppendLine("Читай город");
