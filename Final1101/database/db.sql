...
(1, N'Яуза'),
(2, N'Т8 Издательские технологии'),
(3, N'Прогресс книга'),
(4, N'Время'),
(5, N'Лениздат'),
(6, N'Неолит'),
...
(1, N'Художественная литература'),
(2, N'Учебник для вузов'),
(3, N'Хрестоматия'),
(4, N'Учебное пособие');
...
(N'А112Т4', N'Прокляты и убиты', N'Роман-эпопею "Прокляты и убиты" Виктора Астафьева по праву считают одним из самых сильных и пронзительных произведений отечественной военной прозы.', N'Виктор Астафьев', 585.00, 25, 6, N'1.jpg', 1, 1, 1),
...
(N'D325D4', N'Девайс', N'Молодой фрилансер Захар Скаро устраивается на очередную подработку. Задача, казалось бы, тривиальная: тестирование нового устройства. Вот только вопрос в том, тестированием какой реальности занимается этот новый Девайс?', N'Кирилл Каланджи', 1599.00, 5, 12, N'3.jpg', 1, 1, 2),
(N'S432T5', N'Необыкновенное обыкновенное чудо. Школьные истории', N'', N'Людмила Улицкая', 549.00, 15, 15, N'4.jpg', 1, 1, 2),
(N'F325D4', N'Чук и Гек', N'В книгу вошли повести и рассказы Аркадия Петровича Гайдара: "Чук и Гек", "Горячий камень" и "Сказка о военной тайне, о Мальчише-Кибальчише и его твердом слове"', N'Аркадий Гайдар', 209.00, 18, 3, N'5.jpg', 1, 1, 2),
...
(N'J326V5', N'Тысячелетие императорской керамикиv', N'Фарфор стал величайшим символом китайской культуры. Это одно из выдающихся изобретений, внесших неоценимый вклад в мировую цивилизацию.', N'Янь Чуннянь Янь Чуннянь', 2599.00, 5, 4, N'12.jpg', 1, 3, 5),
...
(N'M642E5', N'Теория искусства. Краткий путеводитель', N'', N'Роджер Осборн, Дэн Стерджис', 879.00, 3, 2, N'15.jpg', 1, 3, 6),
...
(N'J735J7', N'Синтетический образ индивидуального психического мира', N'Психика подобна определенным объектам, это фиксируют сами люди в языке и искусстве. В данном исследовании рассматриваются в этом плане образы сосуда, воронки, дерева и крепости.', N'Сергей Моргачев', 1099.00, 9, 4, N'18.jpg', 1, 3, 8),
(N'H436H7', N'Английский язык в спорте: Учебное пособие', N'Учебное пособие подготовлено для слушателей, изу чающих английский язык как язык специальности', N'Екатерина Габарта, Ирина Игнатьева', 1999.00, 2, 0, N'19.jpg', 1, 4, 9),
...
INSERT INTO Users (Id, FullName, Login, Password, RoleId) VALUES 
(1, N'Никифорова Анна Семеновна', N'94d5ous@gmail.com', N'uzWC67', 1),
(2, N'Стелина Евгения Петровна', N'uth4iz@mail.com', N'2L6KZG', 1),
(3, N'Михайлюк Анна Вячеславовна', N'5d4zbu@tutanota.com', N'rwVDh9', 1),
(4, N'Ситдикова Елена Анатольевна', N'ptec8ym@yahoo.com', N'LdNyos', 2),
(5, N'Ворсин Петр Евгеньевич', N'1qz4kw@mail.com', N'gynQMT', 2),
(6, N'Старикова Елена Павловна', N'4np6se@mail.com', N'AtnDjr', 2),
(7, N'Никифорова Весения Николаевна', N'yzls62@outlook.com', N'JlFRCZ', 3),
(8, N'Сазонов Руслан Германович', N'1diph5e@tutanota.com', N'8ntwUp', 3),
(9, N'Одинцов Серафим Артёмович', N'tjde7c@yahoo.com', N'YOyhfR', 3),
(10, N'Степанов Михаил Артёмович', N'wpmrc3do@tutanota.com', N'RSbvHv', 3);
SET IDENTITY_INSERT Users OFF;
GO

INSERT INTO Orders (Number, OrderDate, DeliveryDate, PickupCode, StatusId, UserId) VALUES 
(1, '2025-02-27', '2025-04-20', N'901', 3, 10),
(2, '2025-03-28', '2025-04-21', N'789', 2, 7),
(3, '2026-02-20', '2026-04-22', N'852', 3, NULL),
(4, '2026-03-01', '2026-04-23', N'458', 2, NULL),
(5, '2026-03-17', '2026-04-24', N'905', 3, NULL),
(6, '2026-03-21', '2026-04-25', N'781', 3, 7),
(7, '2026-03-31', '2026-04-26', N'128', 3, NULL),
(8, '2026-04-02', '2026-04-27', N'908', 1, 9),
(9, '2026-04-03', '2026-04-28', N'719', 1, NULL),
(10, '2026-05-30', '2026-04-29', N'910', 1, 10);
GO

INSERT INTO OrderItem (OrderNumber, ProductArticle, Quantity) VALUES 
(1, N'А112Т4', 2),
(2, N'G843H5', 1),
(2, N'А112Т4', 1),
(3, N'D325D4', 10),
